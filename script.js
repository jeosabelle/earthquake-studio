...
function initAppEvents() {
    ...
    dom.btnMuteAsset.addEventListener('click', () => {
        ...
        dom.btnMuteAsset.innerText = dom.hiddenVideo.muted ? "🔇 Unmute" : "🔊 Mute Music";
    });
...
function handleSaveConfiguration() {
    ...
    document.getElementById('display-activity-title').innerText = `🎬 ${appConfig.title}`;
    renderClassDropdown();
...
function pauseRecordingStudio() {
    ...
    if(mediaRecorder.state === 'recording') {
        ...
        dom.btnPauseRec.innerText = "▶ Resume Rec";
        ...
        dom.btnPauseRec.innerText = "⏸ Pause Rec";
    }
}
    ...
    reader.onloadend = function() {
        ...
        .then(data => {
            if(data.success) {
                ...
                dom.uploadStatusText.innerText = "✅ Upload Successful!";
        ...
        .catch(err => {
            console.error(err);
            dom.uploadStatusText.innerText = "❌ Upload Failed!";
